...
export default function EngagementsSection() {
  ...
  const engagementsData =
    locale === 'de' ? engagementsDataDe : engagementsDataEn;
  const visibleEngagements = engagementsData.filter(
    engagement => engagement.visible,
  );

  return (
    <div id="div2" className="scroll-mt-24 scroll-section">
      <h2
        id="section_engagement"
        className="font-bold text-blue text-3xl sm:text-4xl lg:text-5xl">
