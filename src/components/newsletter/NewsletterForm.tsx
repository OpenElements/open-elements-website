...
export default function NewsletterForm() {
  return (
    <>
      <div className="pb-28 pt-36 max-w-2xl mx-auto relative">
        <div className="sib-form">
          <div id="sib-form-container" className="sib-form-container">
            {/* Error message panel — shown by Brevo main.js on submission failure */}
            <div
              id="error-message"
            ...
            {/* Success message panel — shown by Brevo main.js on successful submission */}
            <div
              id="success-message"
              className="sib-form-message-panel"
              style={{
              ...
              <form
                  ...
                  <div className="sib-input sib-form-block">
                    <div className="form__entry entry_block">
                      ...
                      <label className="entry__specification text-sm sm:ml-5 ml-4 mt-3 inline-block">
                        Gib bitte deine E-Mail-Adresse für die Anmeldung an, z.
                        B. abc@xyz.com.
                      </label>
                    </div>
                  </div>
                ...
                <div style={{ padding: '8px 0' }}>
                  <div className="sib-form-block" style={{ textAlign: 'left' }}>
                    <button
                      className="sib-form-block__button sib-form-block__button-with-loader flex items-center justify-center gap-3 bg-purple hover:bg-purple-700 rounded-full font-bold text-white w-full py-2.5 text-center"
                      form="sib-form"
                      type="submit">
                      <svg
                        className="icon clickable__icon progress-indicator__icon sib-hide-loader-icon animate-spin size-5 text-white fill-current"
                        viewBox="0 0 512 512">
                ...
                <div style={{ padding: '8px 0' }}>
                  <div className="sib-form__declaration flex sm:flex-row flex-col sm:items-center sm:gap-5 gap-1 sm:mt-0 mt-5">
                    ...
                    <p className="text-blue sm:text-sm text-xs leading-6">
                      Wir verwenden Brevo als unsere Marketing-Plattform. Indem
                      du das Formular absendest, erklärst du dich einverstanden,
                      dass die von dir angegebenen persönlichen Informationen an
                      Brevo zur Bearbeitung übertragen werden gemäß den
                      <a
      ...
      {/* Brevo form config — sets validation messages, locale, and translation strings */}
      ...
      {/* Brevo main.js — handles AJAX submission, validation, spinner, and error/success panels */}
      <Script
