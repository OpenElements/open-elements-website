    ...
    <div className="flex items-center justify-center gap-7 mt-12">
      ...
      {currentPage > 1 ? (
        <Link
          ...
          <svg
            className="size-5 -ml-0.5 sm:size-6"
      ...
      {visiblePages[visiblePages.length - 1] < totalPages && (
        <>
          {visiblePages[visiblePages.length - 1] < totalPages - 1 && (
            <span className="inline-flex items-center justify-center w-5 h-11 text-blue rounded-full font-medium text-[14px] page-link">
              ...
            </span>
          )}
          <Link
