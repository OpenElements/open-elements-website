            ...
            <div className="relative hidden mx-auto -mt-8 lg:hidden sm:block">
              <div className="flex gap-2 px-5 py-6 overflow-x-auto xl:items-center lg:px-0 sm:px-12 xl:justify-center scrollbar-none">
                {landingpage.open_knowledge_visible && (
                  <a href="#open-knowledge-section" className="badge-purple">
                    {t('sections.openKnowledge')}
                  </a>
                )}
                {landingpage.open_events_visible && (
                  <a href="#open-events-section" className="badge-purple">
                    {t('sections.openEvents')}
                  </a>
                )}
                {landingpage.open_source_visible && (
                  <a href="#open-source-section" className="badge-purple">
                    {t('sections.openSource')}
                  </a>
                )}
                {landingpage.open_doors_visible && (
                  <a href="#open-doors-section" className="badge-purple">
                    {t('sections.openDoors')}
                  </a>
                )}
                {landingpage.open_data_visible && (
                  <a href="#open-data-section" className="badge-purple">
                    {t('sections.openData')}
                  </a>
                )}
                {landingpage.open_office_visible && (
                  <a href="#open-office-section" className="badge-purple">
                    {t('sections.openOffice')}
                  </a>
                )}
                {landingpage.open_diversity_visible && (
                  <a href="#open-diversity-section" className="badge-purple">
                    {t('sections.openDiversity')}
                  </a>
                )}
              </div>
            </div>
