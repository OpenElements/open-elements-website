        ...
        <div className="container-box">
          <div className="grid gap-10 lg:grid-cols-[1fr_0.85fr] lg:items-center">
            <div>
              ...
              <p className="mt-6 max-w-3xl text-sm font-medium leading-7 sm:text-base">
                {t('distinguish.body')}
              </p>
              <div className="mt-7">
          ...
          <div
            id="engagements"
            className="mt-14 overflow-hidden rounded-[28px] border border-sky-100 bg-white">
            <div className="grid md:grid-cols-2 lg:grid-cols-3">
              {engagements.map((engagement, index) => (
                <article
                  key={engagement.key}
                  className={`min-h-72 border-sky-100 p-7 sm:p-10 ${
                    index % 2 === 0 ? 'md:border-r' : ''
                  } ${index < 4 ? 'md:border-b' : ''} ${
                    index % 3 !== 2 && index % 2 !== 0 ? 'lg:border-r' : ''
                  } ${index % 3 === 2 && index % 2 === 0 ? 'lg:border-r-0' : ''} ${
                    index >= 3 && index < 4 ? 'lg:border-b-0' : ''
                  }`}>
                  <p className="text-xs font-bold uppercase tracking-[0.15em] text-blue/70">
                    {t(`distinguish.engagements.${engagement.key}.category`)}
                  </p>
                  <div className="mt-7 flex min-h-20 items-center">
                    {engagement.logo ? (
                      <Image
                        src={engagement.logo}
                        alt={t(
                  ...
                  <p className="mt-10 text-base font-medium leading-8">
          ...
          <div className="mt-8 grid gap-6 rounded-[20px] border border-sky-100 bg-white p-7 sm:p-10 lg:grid-cols-[1fr_auto] lg:items-center">
          ...
          <div className="mt-10 grid gap-5 border-b border-sky-100 pb-8 sm:grid-cols-[1fr_auto] sm:items-center">
            <p className="text-sm font-medium text-blue/80">
              <span className="mr-4 inline-block size-3 rotate-45 rounded-sm bg-blue align-middle" />
              <span className="mr-5 font-bold uppercase tracking-[0.15em] text-blue">
