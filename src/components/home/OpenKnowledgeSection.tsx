...
export default function OpenKnowledgeSection() {
  ...
  return (
    <div
      id="open-knowledge-section"
      className="container relative max-w-sm px-6 py-12 mx-auto lg:max-w-7xl md:max-w-2xl sm:max-w-xl sm:w-full xl:py-28 sm:py-16 lg:px-0">
          ...
          <div className="relative">
            ...
            <div className="flex flex-col gap-3 mt-5 text-base sm:text-lg">
              <div className="flex items-center gap-2">
                <span
                  className="text-lg iconify text-rose"
                  data-icon="teenyicons:tick-circle-solid"></span>
                {t('item1')}
              </div>
              <div className="flex items-center gap-2">
                <span
                  className="text-lg iconify text-green"
                  data-icon="teenyicons:tick-circle-solid"></span>
                {t('item2')}
              </div>
              <div className="flex items-center gap-2">
                <span
                  className="text-lg iconify text-sky"
                  data-icon="teenyicons:tick-circle-solid"></span>
                {t('item3')}
              </div>
            </div>
